...
function set_cross_domain_listener(full_endpoint, cross_domain_domains, respect_consent_mode, enable_logs) {
  ...
  let cross_domain_listener = function (event) {
    ...
    if (target && target.getAttribute("href")) {
      ...
      const analytics_storage_value = (consent_values.analytics_storage === true || consent_values.analytics_storage === null || consent_values.analytics_storage === undefined) ? true : false;
